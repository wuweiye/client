            ...
            init: function () {
                ...
                var tableConfig = {
                    ajax: function (origin) {
                        http.post(config.api.label.gameLabelList, {
                            data: {
                            ...
                            events: {
                                ...
                                'click .item-delete': function (e, value, row) {
                                    ...
                                    $$.confirm({
                                        ...
                                        trigger: this,
                                        accept: function () {
                                            http.post(config.api.label.gameLabelDelete, {
                                                data: {
                                                    id: row.id
                                                },
                                                contentType: 'form'
                ...
                function dataFromSubmit() {
                    ...
                    if (operating.operateType === 'update') {
                        url = config.api.label.gameLabelUpdate
                    } else {
                        url = config.api.label.gameLabelAdd
                    }
                ...
                http.post(config.api.label.getLabel, {
                    data: {
                        'type': 'get'
                    },
                    contentType: 'form',
                    ...
                    var labelLibrary=$("#labelLibrary");

                    labelLibrary.append(option_str);
                });
