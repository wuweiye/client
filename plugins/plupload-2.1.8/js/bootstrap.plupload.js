                    ...
                    '<div class="plupload_header panel-heading">' +
                        '<div class="plupload_header_content">' +
                            ...
                            '<div class=" btn-group" data-toggle="buttons" style="display:none">' +
                                '<label class="btn btn-primary btn-sm active plupload_button" for="'+obj.id+'_view_list" data-view="list"><input type="hidden" id="'+obj.id+'_view_list" name="view_mode_'+obj.id+'" checked="checked" />' + _('List') + '</label>' +
                                '<label class="btn btn-primary btn-sm plupload_button"  for="'+obj.id+'_view_thumbs" data-view="thumbs"><input type="hidden" id="'+obj.id+'_view_thumbs" name="view_mode_'+obj.id+'" />' + _('Thumbnails') + '</label>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +
