...
/* 2. remote 请求添加 id 参数，通过 data-fetch-id attribute 传入 */
/* 3. Validator.prototype 添加 doSubmitCheck 方法，并对此方法调用做独特的返回，返回一个boolean值 */
...
+function ($) {
  ...
  var Validator = function (element, options) {
    ...
    this.$btn     = $('.' + this.$element.attr('id').substr(0, this.$element.attr('id').length - 4) + 'Submit')
