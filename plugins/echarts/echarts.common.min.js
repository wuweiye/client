! function(t, e) {
	...
	return function(t) {
		...
		t.exports = i(2), i(85), i(79), i(90), i(164), i(197), i(177), i(36), i(188), i(183), i(182), i(167), i(189), i(205)
	}, function(t, e, i) {
		function n(t) {
		...
		function r(t, e, i) {
			...
			for(var a in e)
				if(e.hasOwnProperty(a)) {
					var o = t[a],
						s = e[a];
					!S(s) || !S(o) || b(s) || b(o) || T(s) || T(o) || A(s) || A(o) ? !i && a in t || (t[a] = n(e[a], !0)) : r(o, s, i)
				}
			return t
		}
		...
		O.showLoading = function(t, e) {
			...
			if(i) {
				var n = i.actionInfo,
					...
					a = [t],
					o = !1;
				t.batch && (o = !0, a = T.map(t.batch, function(e) {
					return e = T.defaults(T.extend({}, e), t), e.batch = null, e
				}));
				for(var s, l = [], h = "highlight" === t.type || "downplay" === t.type, c = 0; c < a.length; c++) {
					var u = a[c];
				...
				this._zr.on(t, function(e) {
					...
					if(n && null != n.dataIndex) {
						var r = n.dataModel || i.getSeriesByIndex(n.seriesIndex),
							a = r && r.getDataParams(n.dataIndex, n.dataType) || {};
		...
		Y.init = function(t, e, i) {
			...
			T.isDom(t) ? t = Y.getInstanceByDom(t) : "string" == typeof t && (t = H[t]), t instanceof a && !t.isDisposed() && t.dispose()
		...
		function g(t, e, i, n, r, a) {
			...
			var o = t ? "Update" : "",
				s = n && n.getShallow("animationDuration" + o),
				l = n && n.getShallow("animationEasing" + o),
				h = n && n.getShallow("animationDelay" + o);
			"function" == typeof h && (h = h(r)), n && n.getShallow("animation") ? e.animateTo(i, s, h || 0, l, a) : (e.attr(i), a && a())
		}
		var m = i(1),
			v = i(156),
			y = Math.round,
			...
			M = i(17),
			S = {};
		S.Group = i(27), S.Image = i(46), S.Text = i(65), S.Circle = i(147), S.Sector = i(153), S.Ring = i(152), S.Polygon = i(149), S.Polyline = i(150), S.Rect = i(151), S.Line = i(148), S.BezierCurve = i(146), S.Arc = i(145), S.CompoundPath = i(140), S.LinearGradient = i(76), S.RadialGradient = i(141), S.BoundingRect = i(8), S.extendShape = function(t) {
			return x.extend(t)
			...
			return a = S.applyTransform(a, e, i), Math.abs(a[0]) > Math.abs(a[1]) ? a[0] > 0 ? "right" : "left" : a[1] > 0 ? "bottom" : "top"
		}, t.exports = S
	}, function(t, e) {
		function i(t) {
			...
			getBoundingRect: function() {
				...
				if(this._rect = t, r(e)) {
					...
					if(this.__dirty || i) {
						...
						n(e) || (s = Math.max(s, this.strokeContainThreshold)), l > 1e-10 && (o.width += s / l, o.height += s / l, o.x -= s / l / 2, o.y -= s / l / 2)
					}
					return o
				}
				return t
			...
			contain: function(t, e) {
				...
				if(t = i[0], e = i[1], a.contain(t, e)) {
					...
					if(r(o)) {
						...
						if(c > 1e-10 && (n(o) || (l = Math.max(l, this.strokeContainThreshold)), h.containStroke(s, l / c, t, e))) return !0
					}
					if(n(o)) return h.contain(s, t, e)
				}
				return !1
			},
			dirty: function(t) {
			...
			return a.each(e, function(t, n) {
				if(a.isObject(t))
					for(var r = 0; r < i.length; r++) {
						var o = i[r].exist;
						if(!i[r].option && (null != t.id && o.id === t.id + "" || null != t.name && !s.isIdInner(t) && !s.isIdInner(o) && o.name === t.name + "")) {
		...
		function l(t, e) {
			...
			for(var o = 0; i > o; o++)
				for(var l = 0; l < n.length; l++) t = t.replace(s(f[l], o), e[o][n[l]]);
			return t
		}
		...
		function h(t, e) {
			...
			var i = d.parseDate(e),
				...
				s = i.getMinutes(),
				l = i.getSeconds();
			return t = t.replace("MM", c(r)).toLowerCase().replace("yyyy", n).replace("yy", n % 100).replace("dd", c(a)).replace("d", a).replace("hh", c(o)).replace("h", o).replace("mm", c(s)).replace("m", s).replace("ss", c(l)).replace("s", l)
		}
		...
		function n(t) {
			var e = [];
			return a.each(c.getClassesByMainType(t), function(t) {
		...
		}), s.enableSubTypeDefaulter(c), s.enableTopologicalTravel(c, n), a.mixin(c, i(115)), t.exports = c
	}, function(t, e, i) {
		"use strict";
		...
		function n(t, e, i, n, r) {
			...
			e.eachChild(function(l, h) {
				...
				if("horizontal" === t) {
					...
					c = a + m, c > n || l.newline ? (a = 0, c = m, o += s + i, s = f.height) : s = Math.max(s, f.height)
				} else {
					var v = f.height + (g ? -g.y + f.y : 0);
					u = o + v, u > r || l.newline ? (a += s + i, o = 0, u = v, s = f.width) : s = Math.max(s, f.width)
				}
				l.newline || (d[0] = a, d[1] = o, "horizontal" === t ? a = c + i : o = u + i)
			})
		}
		var r = i(1),
			a = i(8),
		...
		c.box = n, c.vbox = r.curry(n, "vertical"), c.hbox = r.curry(n, "horizontal"), c.getAvailableSize = function(t, e, i) {
			var n = e.width,
				...
				h = l(t.x2, n),
				c = l(t.y2, r);
			return(isNaN(a) || isNaN(parseFloat(t.x))) && (a = 0), (isNaN(h) || isNaN(parseFloat(t.x2))) && (h = n), (isNaN(o) || isNaN(parseFloat(t.y))) && (o = 0), (isNaN(c) || isNaN(parseFloat(t.y2))) && (c = r), i = s.normalizeCssArray(i || 0), {
			...
			var n = e.width,
				...
				g = i[1] + i[3],
				m = t.aspect;
			switch(isNaN(d) && (d = n - c - g - o), isNaN(f) && (f = r - u - p - h), isNaN(d) && isNaN(f) && (m > n / r ? d = .8 * n : f = .8 * r), null != m && (isNaN(d) && (d = m * f), isNaN(f) && (f = d / m)), isNaN(o) && (o = n - c - d - g), isNaN(h) && (h = r - u - f - p), t.left || t.right) {
				case "center":
					o = n / 2 - d / 2 - i[3];
					break;
				case "right":
			...
			o = o || 0, h = h || 0, isNaN(d) && (d = n - o - (c || 0)), isNaN(f) && (f = r - h - (u || 0));
			var v = new a(o + i[3], h + i[0], d, f);
			return v.margin = i, v
			...
			e = r.extend(r.clone(e), {
				width: a.width,
				height: a.height
			}), e = c.getLayoutRect(e, i, n), t.position = [e.x - a.x, e.y - a.y]
			...
			function n(n) {
				...
				if(h(n, function(e) {
						...
						a(e, t) && (r[t] = l[t] = e[t]), o(r, t) && s++, o(l, t) && c++
					}), c !== u && s) {
					if(s >= u) return r;
		...
		var o = r.mixin;
		o(n, i(117)), o(n, i(114)), o(n, i(118)), o(n, i(116)), t.exports = n
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
			r = i(9),
			...
			h = o.extend({
				...
				formatTooltip: function(t, e, i) {
					...
					return e ? u + s(this.name) + " : " + o : s(this.name) + "<br />" + u + (h ? s(h) + " : " + o : o)
				},
				restoreData: function() {
		...
		(function(e) {
			...
			var a = "undefined",
				...
				v = function(t, e) {
					...
					this.dimensions = n, this._dimensionInfos = i, this.hostModel = e, this.dataType, this.silent = !1, this.indices = [], this._storage = {}, this._nameList = [], this._idList = [], this._optionModels = [], this.stackedOn = null, this._visual = {}, this._layout = {}, this._itemVisuals = [], this._itemLayouts = [], this._graphicEls = [], this._rawData, this._extent
				},
				y = v.prototype;
			y.type = "list", y.getDimension = function(t) {
				...
				for(var l = 0; l < s.length; l++)
					if(0 === o) e.call(r, l);
					else if(1 === o) e.call(r, this.get(t[0], l, i), l);
				else {
				...
				for(var h = 0; h < l.length; h++) {
					...
					if(1 === s) c = e.call(r, this.get(t[0], h, i), h);
						...
						for(var u = 0; s > u; u++) o[u] = this.get(t[u], h, i);
						o[u] = h, c = e.apply(r, o)
					}
					c && a.push(l[h])
				}
				return this.indices = a, this._extent = {}, !this.silent && this.__onChange(), this
				...
				}, i, a), !this.silent && this.__onTransfer(o), o
			}, y.downSample = function(t, e, i, n) {
				for(var a = r(this, [t]), o = this._storage, s = a._storage, l = this.indices, h = a.indices = [], c = [], u = [], d = Math.floor(1 / e), f = s[t], p = this.count(), g = 0; g < o[t].length; g++) s[t][g] = o[t][g];
				for(var g = 0; p > g; g += d) {
				...
				return !this.silent && this.__onTransfer(a), a
			...
			y.setItemGraphicEl = function(t, e) {
				...
				return e._storage = this._storage, m(e, this), e.indices = this.indices.slice(), !this.silent && this.__onTransfer(e), e
			...
			}, y.__onTransfer = y.__onChange = d.noop, t.exports = v
		}).call(e, function() {
			return this
		}())
	}, function(t, e, i) {
		...
		function s(t, e, i, r, a, o) {
			...
			if(n(u) && n(d))
				...
				if(n(m)) {
					...
					g >= 0 && 1 >= g && (o[p++] = g), y >= 0 && 1 >= y && (o[p++] = y), L >= 0 && 1 >= L && (o[p++] = L)
				}
			}
			return p
		}
		...
		function h(t, e, i, n, r, a) {
			var o = (e - t) * r + t,
				...
				c = (l - s) * r + s,
				u = (c - h) * r + h;
			a[0] = t, a[1] = o, a[2] = h, a[3] = u, a[4] = u, a[5] = c, a[6] = l, a[7] = n
		}

		function c(t, e, i, n, r, o, s, l, h, c, u) {
			var d, f, p, g, m, v = .005,
				y = 1 / 0;
			T[0] = h, T[1] = c;
			for(var _ = 0; 1 > _; _ += .05) C[0] = a(t, i, r, s, _), C[1] = a(e, n, o, l, _), g = x(T, C), y > g && (d = _, y = g);
			y = 1 / 0;
			for(var w = 0; 32 > w && !(M > v); w++) f = d - v, p = d + v, C[0] = a(t, i, r, s, f), C[1] = a(e, n, o, l, f), g = x(C, T), f >= 0 && y > g ? (d = f, y = g) : (I[0] = a(t, i, r, s, p), I[1] = a(e, n, o, l, p), m = x(I, T), 1 >= p && y > m ? (d = p, y = m) : v *= .5);
			return u && (u[0] = a(t, i, r, s, d), u[1] = a(e, n, o, l, d)), b(y)
		}
		...
		function m(t, e, i, n, r, a, o, s, l) {
			...
			for(var g = 0; 32 > g && !(M > c); g++) {
				var m = h - c,
					v = h + c;
				C[0] = u(t, i, r, m), C[1] = u(e, n, a, m);
				var p = x(C, T);
				if(m >= 0 && d > p) h = m, d = p;
				else {
					I[0] = u(t, i, r, v), I[1] = u(e, n, a, v);
					var y = x(I, T);
					1 >= v && d > y ? (h = v, d = y) : c *= .5
				}
			}
			return l && (l[0] = u(t, i, r, h), l[1] = u(e, n, a, h)), b(d)
		}
		var v = i(5),
			y = v.create,
			x = v.distSquare,
		...
		function a(t, e, i, n) {
			...
			switch(t) {
				...
				case "right":
					...
					break;
				case "top":
					r += s / 2, a -= n + l, c = "center";
					break;
				case "bottom":
					r += s / 2, a += o + n, c = "center";
					break;
				case "inside":
					r += s / 2, a += h, c = "center";
					break;
		...
		function o(t, e, i, r) {
			...
			for(var a = (t + "").split("\n"), o = 0, l = a.length; l > o; o++) a[o] = s(a[o], e, i, r);
			return a.join("\n")
		}
		...
		function s(t, e, i, r) {
			for(var a = 0;; a++) {
				var o = n(t, e);
				if(i > o || a >= r.maxIterations) {
					t += r.ellipsis;
					break
				}
				var s = 0 === a ? l(t, i, r) : Math.floor(t.length * i / o);
		...
		function l(t, e, i) {
			for(var n = 0, r = 0, a = t.length; a > r && e > n; r++) {
			...
			n = {
				...
				rotate: function(t, e, i) {
					var n = e[0],
						...
						h = Math.sin(i),
						c = Math.cos(i);
					return t[0] = n * c + o * h, t[1] = -n * h + o * c, t[2] = r * c + s * h, t[3] = -r * h + c * s, t[4] = c * a + h * l, t[5] = c * l - h * a, t
				},
				scale: function(t, e, i) {
					var n = i[0],
						r = i[1];
		...
		o.enableClassExtend = function(t, e) {
			t.extend = function(i) {
				...
				return a.extend(o.prototype, i), o.extend = this.extend, o.superCall = n, o.superApply = r, a.inherits(o, this), o.superClass = this, o
			}
			...
			if(t) {
				...
				if(0 === l) e = 0, i = 0;
					...
					var c = ((s - n) / 6 + l / 2) / l,
						u = ((s - r) / 6 + l / 2) / l,
						d = ((s - a) / 6 + l / 2) / l;
					n === s ? e = d - u : r === s ? e = 1 / 3 + c - d : a === s && (e = 2 / 3 + u - c), 0 > e && (e += 1), e > 1 && (e -= 1)
				}
				var f = [360 * e, i, h];
		...
		function m(t, e, i, r) {
			return t = h(t), t ? (t = u(t), null != e && (t[0] = n(e)), null != i && (t[1] = o(i)), null != r && (t[2] = o(r)), y(c(t), "rgba")) : void 0
		}
		...
		h.getScaleExtent = function(t, e) {
			...
			var a = e.getMin ? e.getMin() : e.get("min"),
				...
				c = e.get("boundaryGap");
			s.isArray(c) || (c = [c || 0, c || 0]), c[0] = o.parsePercent(c[0], 1), c[1] = o.parsePercent(c[1], 1);
			var u = !0,
				d = !0;
			return null == a && (a = n[0] - c[0] * r, u = !1), null == l && (l = n[1] + c[1] * r, d = !1), "dataMin" === a && (a = n[0]), "dataMax" === l && (l = n[1]), h && (a > 0 && l > 0 && !u && (a = 0), 0 > a && 0 > l && !d && (l = 0)), [a, l]
			...
			for(var h = 0; h < t.length; h += s) {
				...
				u[n ? "x" : "y"] += c, u[n ? "width" : "height"] *= 1.5, r ? r.intersect(u) ? (o++, a = Math.max(a, o)) : (r.union(u), o = 0) : r = u.clone()
			}
		...
		var f = n.extendShape({
			...
			g = {
				createSymbol: function(t, e, i, a, o, s) {
					...
					}) : 0 === t.indexOf("path://") ? n.makePath(t.slice(7), {}, new r(e, i, a, o)) : new f({
						shape: {
							symbolType: t,
							x: e,
							y: i,
		...
		_.prototype = {
			...
			beginPath: function(t) {
				return this._ctx = t, t && t.beginPath(),
					this._len = 0, this._lineDash && (this._lineDash = null, this._dashOffset = 0), this
			},
			moveTo: function(t, e) {
			...
			_dashedLineTo: function(t, e) {
				var i, n, r = this._dashSum,
					...
					m = h,
					y = o.length;
				for(c /= d, u /= d, 0 > a && (a = r + a), a %= r, g -= a * c, m -= a * u; c >= 0 && t >= g || 0 > c && g > t;) n = this._dashIdx, i = o[n], g += c * i, m += u * i, this._dashIdx = (n + 1) % y, c > 0 && l > g || 0 > c && g > l || s[n % 2 ? "moveTo" : "lineTo"](c >= 0 ? f(g, t) : p(g, t), u >= 0 ? f(m, e) : p(m, e));
			...
			_dashedBezierTo: function(t, e, i, r, a, o) {
				var s, l, h, c, u, d = this._dashSum,
					...
					w = p.length,
					M = 0;
				for(0 > f && (f = d + f), f %= d, s = 0; 1 > s; s += .1) l = x(m, t, i, a, s + .1) - x(m, t, i, a, s), h = x(y, e, r, o, s + .1) - x(y, e, r, o, s), _ += v(l * l + h * h);
				for(; w > b && (M += p[b], !(M > f)); b++);
				for(s = (M - f) / _; 1 >= s;) c = x(m, t, i, a, s), u = x(y, e, r, o, s), b % 2 ? g.moveTo(c, u) : g.lineTo(c, u), s += p[b] / _, b = (b + 1) % w;
				b % 2 !== 0 && g.lineTo(a, o), l = a - c, h = o - u, this._dashOffset = -v(l * l + h * h)
			},
			...
			getBoundingRect: function() {
				...
				for(var t = this.data, e = 0, i = 0, n = 0, s = 0, f = 0; f < t.length;) {
					...
					switch(1 == f && (e = t[f], i = t[f + 1], n = e, s = i), p) {
						case l.M:
							...
							break;
						case l.L:
							a.fromLine(e, i, t[f], t[f + 1], u, d), e = t[f++], i = t[f++];
							break;
						case l.C:
							a.fromCubic(e, i, t[f++], t[f++], t[f++], t[f++], t[f], t[f + 1], u, d), e = t[f++], i = t[f++];
							break;
						case l.Q:
							a.fromQuadratic(e, i, t[f++], t[f++], t[f], t[f + 1], u, d), e = t[f++], i = t[f++];
							break;
						case l.A:
							var v = t[f++],
								y = t[f++],
								...
								w = t[f++] + b,
								M = (t[f++], 1 - t[f++]);
							1 == f && (n = g(b) * x + v, s = m(b) * _ + y), a.fromArc(v, y, x, _, b, w, M, u, d), e = g(w) * x + v, i = m(w) * _ + y;
							break;
						case l.R:
							n = e = t[f++], s = i = t[f++];
							var S = t[f++],
								A = t[f++];
							a.fromLine(n, s, n + S, s + A, u, d);
							break;
						case l.Z:
							e = n, i = s
					}
				...
				return 0 === f && (h[0] = h[1] = c[0] = c[1] = 0), new o(h[0], h[1], c[0] - h[0], c[1] - h[1])
			},
			rebuildPath: function(t) {
				for(var e, i, n, r, a, o, s = this.data, h = this._ux, c = this._uy, u = this._len, d = 0; u > d;) {
					var f = s[d++];
					switch(1 == d && (n = s[d], r = s[d + 1], e = n, i = r), f) {
						case l.M:
							...
							break;
						case l.L:
							a = s[d++], o = s[d++], (y(a - n) > h || y(o - r) > c || d === u - 1) && (t.lineTo(a, o), n = a, r = o);
							break;
						case l.C:
		...
		function a(t, e, i) {
			...
			var n = e.get("coordinateSystem"),
				...
				s = a && a(t, e, i),
				d = s && s.dimensions;
			d || (d = o && o.dimensions || ["x", "y"], d = c(d, t, d.concat(["value"])));
			var v, y = s && s.categoryAxisModel,
				...
				w = y && r(t) ? function(t, e, i, n) {
					...
					var r = p(t),
						a = g(r && r[n], d[n]);
					return x === n && "string" == typeof a && (v = v || y.getCategories(), a = u.indexOf(v, a), 0 > a && !isNaN(a) && (a = +a)), a
				};
			...
			l = a.extend({
				...
				getTicks: function() {
					...
					if(t) {
						...
						e[0] < a[0] && i.push(e[0]);
						for(var o = a[0]; o <= a[1];)
							if(i.push(o), o = n.round(o + t), i.length > r) return [];
						e[1] > a[1] && i.push(e[1])
					}
					return i
				},
				...
				niceTicks: function(t) {
					...
					if(isFinite(i)) {
						0 > i && (i = -i, e.reverse());
						var r = n.nice(i / t, !0),
							a = [n.round(s(e[0] / r) * r), n.round(o(e[1] / r) * r)];
				...
				niceExtent: function(t, e, i) {
					...
					e || (r[0] = n.round(o(r[0] / h) * h)), i || (r[1] = n.round(s(r[1] / h) * h))
				}
			});
		l.create = function() {
			return new l
		...
		s.updateData = function(t, e) {
			...
			t.diff(o).add(function(n) {
				...
				var c = o.getItemGraphicEl(h),
					u = t.getItemLayout(l);
				return r(t, l, e) ? (c ? (c.updateData(t, l), a.updateProps(c, {
					position: u
		...
		var a = i(1),
			...
			d = s.extendComponentModel({
				...
				doInit: function(t) {
					var e = this.option;
					o.canvasSupported || (e.realtime = !1), r("start", "startValue", t, e), r("end", "endValue", t, e), this.textStyleModel = this.getModel("textStyle"), this._resetTarget(), this._giveAxisProxies()
				},
				_giveAxisProxies: function() {
					var t = this._axisProxies;
					this.eachTargetAxis(function(e, i, n, r) {
						var a = this.dependentModels[e.axis][i],
							o = a.__dzAxisProxy || (a.__dzAxisProxy = new h(e.name, i, this, r));
						t[e.name + "_" + i] = o
					}, this)
				},
			...
			function i(t) {
				...
				return n.each(t, function(s) {
					var l = r(i, s),
						...
						c = a(h, t);
					l.entryCount = c.length, 0 === l.entryCount && o.push(s), n.each(c, function(t) {
				...
				if(t.length) {
					...
					for(n.each(t, function(t) {
						...
						var d = c.pop(),
							f = h[d],
							p = !!u[d];
						p && (r.call(a, d, f.originalDeps.slice()), delete u[d]), n.each(f.successor, p ? s : o)
					}
					n.each(u, function() {
			...
			brush: function(t) {
				...
				if(e) {
					...
					if(t.save(), i.bind(t), this.setTransform(t), i.r && (t.beginPath(), s.buildPath(t, i), t.clip()), i.sWidth && i.sHeight) {
						var u = i.sx || 0,
							d = i.sy || 0;
						t.drawImage(e, u, d, i.sWidth, i.sHeight, l, c, a, o)
					} else if(i.sx && i.sy) {
						var u = i.sx,
							d = i.sy,
							f = a - u,
							p = o - d;
						t.drawImage(e, u, d, f, p, l, c, a, o)
					} else t.drawImage(e, l, c, a, o);
					null == i.width && (i.width = a), null == i.height && (i.height = o), null != i.text && this.drawRectText(t, this.getBoundingRect()), t.restore()
				}
			},
			getBoundingRect: function() {
				var t = this.style;
		...
		c._updateCommon = function(t, e, i) {
			...
			r.setColor(g), o.extend(m, c.getItemStyle(["color"]));
			var _ = t.getItemVisual(e, "opacity");
			null != _ && (m.opacity = _);
			for(var b, w = s.getModel(f), M = s.getModel(p), S = t.dimensions.slice(), A = S.pop();
				"ordinal" === (b = t.getDimensionInfo(A).type) || "time" === b;) A = S.pop();
			w.get("show") ? (l.setText(m, w, g), m.text = o.retrieve(a.getFormattedLabel(e, "normal"), t.get(A, e))) : m.text = "", M.getShallow("show") ? (l.setText(v, M, g), v.text = o.retrieve(a.getFormattedLabel(e, "emphasis"), t.get(A, e))) : v.text = "";
		...
		function r(t, e, i) {
			for(var n = 0; n < t.length; n++) {
				var r = i(t[n]),
					a = e[r];
				null == a ? e[r] = n : (a.length || (e[r] = a = [a]), a.push(n))
			}
		}
		n.prototype = {
			constructor: n,
			...
			execute: function() {
				var t, e = this._old,
					...
					o = {},
					s = {};
				for(r(e, o, n), r(i, s, a), t = 0; t < e.length; t++) {
					var l = n(e[t]),
						h = s[l];
					if(null != h) {
						var c = h.length;
		...
		function r(t, e, i) {
			var n, r, a = c(e - t.rotation);
			return u(a) ? (r = i > 0 ? "top" : "bottom", n = "center") : u(a - d) ? (r = i > 0 ? "bottom" : "top", n = "center") : (r = "middle", n = a > 0 && d > a ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"), {
				rotation: a,
				textAlign: n,
				verticalAlign: r
			}
		...
		function a(t, e, i) {
			var n, r, a = c(-t.rotation),
				o = i[0] > i[1],
				s = "start" === e && !o || "start" !== e && o;
			return u(a - d / 2) ? (r = s ? "bottom" : "top", n = "center") : u(a - 1.5 * d) ? (r = s ? "top" : "bottom", n = "center") : (r = "middle", n = 1.5 * d > a && a > d / 2 ? s ? "left" : "right" : s ? "right" : "left"), {
				rotation: a,
				textAlign: n,
				verticalAlign: r
			}
		...
		var p = {
				...
				axisTick: function() {
					...
					if(t.get("axisTick.show")) {
						for(var e = t.axis, i = t.getModel("axisTick"), n = this.opt, r = i.getModel("lineStyle"), a = i.get("length"), o = m(i, n.labelInterval), l = e.getTicksCoords(), h = [], c = 0; c < l.length; c++)
							if(!g(e, c, o)) {
								var u = l[c];
				...
				axisLabel: function() {
					...
					if(e.get("axisLabel.show")) {
						var i = this.opt,
							...
							p = i.labelRotation;
						null == p && (p = o.get("rotate") || 0), p = p * d / 180;
				...
				axisName: function() {
					...
					if(null == i && (i = e.get("name")), i) {
						...
						o = "middle" === l ? r(t, t.rotation, h) : a(t, l, d);
						var g = new s.Text({
							style: {
								text: i,
								textFont: c.getFont(),
		...
		g.type = "grid", g.getRect = function() {
				...
				return function(r, h) {
					if(n(r, t, e)) {
						...
						var d = new u(i, l.createScaleByModel(r), [0, 0], r.get("type"), c),
							f = "category" === d.type;
						d.onBand = f && r.get("boundaryGap"), d.inverse = r.get("inverse"), d.onZero = r.get("axisLine.onZero"), r.axis = d, d.model = r, d.index = h, this._axesList.push(d), o[i][h] = d, s[i]++
					}
				}
			}
			var a = {
			...
			return e.eachComponent("xAxis", r("x"), this), e.eachComponent("yAxis", r("y"), this), s.x && s.y ? (this._axesMap = o, void d(o.x, function(t, e) {
				d(o.y, function(i, n) {
					var r = "x" + e + "y" + n,
						a = new c(r);
		...
		}, a.dimensions = c.prototype.dimensions, i(23).register("cartesian2d", a), t.exports = a
	}, function(t, e) {
		...
		function s(t, e, i, n, r) {
			var o = t.length;
			if(1 == r)
				for(var s = 0; o > s; s++) n[s] = a(t[s], e[s], i);
			else
		...
		function c(t, e, i, n, r, a, o, s, l) {
			var h = t.length;
			if(1 == l)
				for(var c = 0; h > c; c++) s[c] = u(t[c], e[c], i[c], n[c], r, a, o);
			else
				for(var d = t[0].length, c = 0; h > c; c++)
					for(var f = 0; d > f; f++) s[c][f] = u(t[c][f], e[c][f], i[c][f], n[c][f], r, a, o)
		}
		...
		function p(t, e, i, n, r) {
			...
			if(x) {
				...
				if(!k) {
					if(w) {
						for(var O = C[x - 1], L = 0; x - 1 > L; L++) l(C[L], O, A);
						l(d(t._target, r), O, A)
					}
					var z, E, R, B, N, V, F = 0,
						G = 0;
							...
							if(0 !== n)
								if(E = (e - T[i]) / n, v)
									if(B = C[i], R = C[0 === i ? i : i - 1], N = C[i > x - 2 ? x - 1 : i + 1], V = C[i > x - 3 ? x - 1 : i + 2], w) c(R, B, N, V, E, E * E, E * E * E, d(t, r), A);
										...
										var l;
										if(M) l = c(R, B, N, V, E, E * E, E * E * E, W, 1), l = f(W);
										else {
											if(S) return o(B, N, E);
								...
								var l;
								if(M) s(C[i], C[i + 1], E, W, 1), l = f(W);
								else {
									if(S) return o(C[i], C[i + 1], E);
									l = a(C[i], C[i + 1], E)
								}
								p(t, r, l)
							}
		...
		t.exports = {
			buildPath: function(t, e) {
				var i, n, r, a, o = e.x,
					...
					h = e.height,
					c = e.r;
				0 > l && (o += l, l = -l), 0 > h && (s += h, h = -h), "number" == typeof c ? i = n = r = a = c : c instanceof Array ? 1 === c.length ? i = n = r = a = c[0] : 2 === c.length ? (i = r = c[0], n = a = c[1]) : 3 === c.length ? (i = c[0], n = a = c[1], r = c[2]) : (i = c[0], n = c[1], r = c[2], a = c[3]) : i = n = r = a = 0;
				var u;
				i + n > l && (u = i + n, i *= l / u, n *= l / u), r + a > l && (u = r + a, r *= l / u, a *= l / u), n + r > h && (u = n + r, n *= h / u, r *= h / u), i + a > h && (u = i + a, i *= h / u, a *= h / u), t.moveTo(o + i, s), t.lineTo(o + l - n, s), 0 !== n && t.quadraticCurveTo(o + l, s, o + l, s + n), t.lineTo(o + l, s + h - r), 0 !== r && t.quadraticCurveTo(o + l, s + h, o + l - r, s + h), t.lineTo(o + a, s + h), 0 !== a && t.quadraticCurveTo(o, s + h, o, s + h - a), t.lineTo(o, s + i), 0 !== i && t.quadraticCurveTo(o, s, o + i, s)
			}
		}
	}, function(t, e, i) {
		var n = i(72),
		...
		a.fromPoints = function(t, e, i) {
			if(0 !== t.length) {
				var n, r = t[0],
					...
					h = r[1],
					c = r[1];
				for(n = 1; n < t.length; n++) r = t[n], a = o(a, r[0]), l = s(l, r[0]), h = o(h, r[1]), c = s(c, r[1]);
				e[0] = a, e[1] = h, i[0] = l, i[1] = c
			}
		...
		var p = [],
			g = [];
		a.fromCubic = function(t, e, i, n, a, l, h, c, u, d) {
			var f, m = r.cubicExtrema,
				v = r.cubicAt,
				y = m(t, i, a, h, p);
			for(u[0] = 1 / 0, u[1] = 1 / 0, d[0] = -(1 / 0), d[1] = -(1 / 0), f = 0; y > f; f++) {
				var x = v(t, i, a, h, p[f]);
				u[0] = o(x, u[0]), d[0] = s(x, d[0])
			}
			for(y = m(e, n, l, c, g), f = 0; y > f; f++) {
				var _ = v(e, n, l, c, g[f]);
				u[1] = o(_, u[1]), d[1] = s(_, d[1])
			}
			u[0] = o(t, u[0]), d[0] = s(t, d[0]), u[0] = o(h, u[0]), d[0] = s(h, d[0]), u[1] = o(e, u[1]), d[1] = s(e, d[1]), u[1] = o(c, u[1]), d[1] = s(c, d[1])
		}, a.fromQuadratic = function(t, e, i, n, a, l, h, c) {
			var u = r.quadraticExtremum,
				...
				g = d(t, i, a, f),
				m = d(e, n, l, p);
			h[0] = o(t, a, g), h[1] = o(e, l, m), c[0] = s(t, a, g), c[1] = s(e, l, m)
		}, a.fromArc = function(t, e, i, r, a, o, s, p, g) {
			var m = n.min,
				v = n.max,
				y = Math.abs(a - o);
			if(1e-4 > y % f && y > 1e-4) return p[0] = t - i, p[1] = e - r, g[0] = t + i, void(g[1] = e + r);
			if(c[0] = h(a) * i + t, c[1] = l(a) * r + e, u[0] = h(o) * i + t, u[1] = l(o) * r + e, m(p, c, u), v(g, c, u), a %= f, 0 > a && (a += f), o %= f, 0 > o && (o += f), a > o && !s ? o += f : o > a && s && (a += f), s) {
				var x = o;
				o = a, a = x
			}
			for(var _ = 0; o > _; _ += Math.PI / 2) _ > a && (d[0] = h(_) * i + t, d[1] = l(_) * r + e, m(p, d, p), v(g, d, g))
		}, t.exports = a
	}, function(t, e, i) {
		var n = i(37),
			r = i(1),
		...
		o.prototype = {
			...
			brush: function(t) {
				...
				if(null != r && (r += ""), r) {
					...
					for(var h = a.measureText("国", t.font).width, c = r.split("\n"), u = 0; u < c.length; u++) o && t.fillText(c[u], i, n), s && t.strokeText(c[u], i, n), n += h;
					t.restore()
				}
			},
			getBoundingRect: function() {
			...
			drawRectText: function(t, e, i) {
				...
				if(null != l && (l += ""), l) {
					...
					var v = this.transform,
						y = this.invTransform;
					if(v && (s.copy(e), s.applyTransform(v), e = s, r(t, y)), u instanceof Array) h = e.x + n(u[0], e.width), c = e.y + n(u[1], e.height), f = f || "left", g = g || "top";
					else {
						var x = a.adjustTextPositionOnRect(u, e, i, d);
		...
		var r = i(58),
			...
			u = {},
			d = {};
		d.version = "3.0.9", d.init = function(t, e) {
			var i = new f(r(), t, e);
			return u[i.id] = i, i
		...
		var f = function(t, e, i) {
			...
			var d = new c[u](e, r, i);
			this.storage = r, this.painter = d, a.node || (this.handler = new o(d.getViewportRoot(), r, d)), this.animation = new l({
				stage: {
					update: function() {
		...
		t.exports = function(t, e, i) {
			function r(t) {
				...
				o.setVisual("color", s), i.isSeriesFiltered(t) || ("function" != typeof s || s instanceof n || o.each(function(e) {
		...
		var n = i(1),
			...
			a = function(t, e, i, n, a) {
				this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == i ? 1 : i, this.y2 = null == n ? 0 : n, r.call(this, a)
			};
		a.prototype = {
			constructor: a,
			type: "linear"
		...
		var r = i(109),
			a = i(2);
		a.registerLayout(n.curry(r, "bar")), a.registerVisualCoding("chart", function(t) {
				...
				function o(e, i) {
					...
					if(f) {
						var c = h.shape,
							u = d ? "height" : "width",
							g = {};
						c[u] = 0, g[u] = o[u], a[i ? "updateProps" : "initProps"](h, {
							shape: g
						}, t, e)
					}
					return h
			...
			_updateStyle: function(t, e, i) {
				...
				e.eachItemGraphicEl(function(o, s) {
					...
					var p = i ? u.height > 0 ? "bottom" : "top" : u.width > 0 ? "left" : "right",
						...
						v = o.style;
					g.get("show") ? n(v, g, h, r.retrieve(t.getFormattedLabel(s, "normal"), t.getRawValue(s)), p) : v.text = "", m.get("show") ? n(f, m, h, r.retrieve(t.getFormattedLabel(s, "emphasis"), t.getRawValue(s)), p) : f.text = "", a.setHoverStyle(o, f)
				})
			},
			remove: function(t, e) {
				var i = this.group;
		...
		function r(t, e, i) {
			...
			if(r && "none" !== r) {
				f.isArray(a) || (a = [a, a]);
				var o = h.createSymbol(r, -a[0] / 2, -a[1] / 2, a[0], a[1], n);
				return o.name = t, o
			}
		}
		...
		function s() {
			...
			if(e || i || !n.ignore) {
				...
				if(this.__dirty || o.__dirty) {
					var s = o.pointAt(0),
						l = o.pointAt(o.shape.percent),
						h = c.sub([], l, s);
					if(c.normalize(h, h), e) {
						e.attr("position", s);
						var u = o.tangentAt(0);
						e.attr("rotation", -Math.PI / 2 - Math.atan2(u[1], u[0])), e.attr("scale", [r, r])
					}
					if(i) {
						i.attr("position", l);
						var u = o.tangentAt(1);
						i.attr("rotation", -Math.PI / 2 - Math.atan2(u[1], u[0])), i.attr("scale", [r, r])
					}
					if(!n.ignore) {
						n.attr("position", l);
						var d, f, p, g = 5 * r;
						if("end" === n.__position) d = [h[0] * g + l[0], h[1] * g + l[1]], f = h[0] > .8 ? "left" : h[0] < -.8 ? "right" : "center", p = h[1] > .8 ? "top" : h[1] < -.8 ? "bottom" : "middle";
						else if("middle" === n.__position) {
							var m = o.shape.percent / 2,
								u = o.tangentAt(m),
								v = [u[1], -u[0]],
								y = o.pointAt(m);
							v[1] > 0 && (v[0] = -v[0], v[1] = -v[1]), d = [y[0] + v[0] * g, y[1] + v[1] * g], f = "center", p = "bottom";
							var x = -Math.atan2(u[1], u[0]);
							l[0] < s[0] && (x = Math.PI + x), n.attr("rotation", x)
						} else d = [-h[0] * g + s[0], -h[1] * g + s[1]], f = h[0] > .8 ? "right" : h[0] < -.8 ? "left" : "center", p = h[1] > .8 ? "bottom" : h[1] < -.8 ? "top" : "middle";
						n.attr({
							style: {
		...
		m.beforeUpdate = s, m._createLine = function(t, e) {
			...
			o(l.shape, s), d.updateProps(a, l, i, e), f.each(g, function(i) {
			...
			u.setStyle({
				...
				textFont: o.getFont(),
				fill: o.getTextColor() || c
			}), u.hoverStyle = {
				text: s.get("show") ? f.retrieve(i.getFormattedLabel(e, "emphasis", t.dataType), h) : "",
				textFont: l.getFont(),
				fill: l.getTextColor() || c
			}, u.__textAlign = o.get("align"), u.__verticalAlign = o.get("baseline"), u.__position = a.get("position"), u.ignore = !u.style.text && !u.hoverStyle.text, d.setHoverStyle(this)
		}, m.updateLayout = function(t, e) {
			var i = t.getItemLayout(e),
				n = this.childOfName("line");
			o(n.shape, i), n.dirty(!0)
		...
		o.updateData = function(t) {
			...
			t.diff(e).add(function(e) {
				...
				a.updateData(t, n), t.setItemGraphicEl(n, a), i.add(a)
			}).remove(function(t) {
		...
		function s(t, e) {
			...
			return e.mapArray([a], function(n, l) {
				for(var h, c = e.stackedOn; c && o(c.get(a, l)) === o(n);) {
					h = c;
					break
				}
				var u = [];
				return u[s] = e.get(i.dim, l), u[1 - s] = h ? h.get(a, l, !0) : r, t.dataToPoint(u)
			}, !0)
		}
		...
		function h(t, e, i) {
			...
			return e && (f.shape[o ? "width" : "height"] = 0, m.initProps(f, {
				shape: {
					width: h,
					height: c
				}
		...
		function c(t, e, i) {
			...
			return e && (l.shape.endAngle = -o[0] * s, m.initProps(l, {
				shape: {
					endAngle: -o[1] * s
				}
			}, i)), l
		...
		t.exports = y.extend({
			...
			render: function(t, e, i) {
				...
				A && A.eachItemGraphicEl(function(t, e) {
					t.__temp && (o.remove(t), A.setItemGraphicEl(e, null))
				}), M || m.remove(), o.add(x), v && g.type === a.type ? (b && !y ? y = this._newPolygon(f, w, a, _) : y && !b && (x.remove(y), y = this._polygon = null), x.setClipPath(u(a, !1, t)), M && m.updateData(l, S), l.eachItemGraphicEl(function(t) {
					t.stopAnimation(!0)
					...
					points: f,
					stackedOnPoints: w
				})))) : (M && m.updateData(l, S), v = this._newPolyline(f, a, _), b && (y = this._newPolygon(f, w, a, _)), x.setClipPath(u(a, !0, t))), v.useStyle(d.defaults(h.getLineStyle(), {
					fill: "none",
			...
			highlight: function(t, e, i, n) {
				...
				if(null != a && a >= 0) {
					...
					if(!o) {
						...
						o = new p(r, a, i), o.position = s, o.setZ(t.get("zlevel"), t.get("z")), o.ignore = isNaN(s[0]) || isNaN(s[1]), o.__temp = !0, r.setItemGraphicEl(a, o), o.stopSymbolAnimation(!0), this.group.add(o)
					}
					o.highlight()
		...
		function n(t, e, n) {
			for(var r, a = t.getBaseAxis(), o = t.getOtherAxis(a), s = a.onZero ? 0 : o.scale.getExtent()[0], l = o.dim, h = "x" === l || "radius" === l ? 1 : 0, c = e.stackedOn, u = e.get(l, n); c && i(c.get(l, n)) === i(u);) {
				r = c;
				break
			}
			var d = [];
			return d[h] = e.get(a.dim, n), d[1 - h] = r ? r.get(l, n, !0) : s, t.dataToPoint(d)
		}
			...
			for(var l = r(t, e), h = [], c = [], u = [], d = [], f = [], p = [], g = [], m = s.dimensions, v = 0; v < l.length; v++) {
				...
				switch(y.cmd) {
					case "=":
						...
						(isNaN(_[0]) || isNaN(_[1])) && (_ = b.slice()), h.push(_), c.push(b), u.push(i[y.idx]), d.push(a[y.idx1]), g.push(e.getRawIndex(y.idx1));
						break;
					case "+":
						var w = y.idx;
						h.push(o.dataToPoint([e.get(m[0], w, !0), e.get(m[1], w, !0)])), c.push(e.getItemLayout(w).slice()), u.push(n(o, e, w)), d.push(a[w]), g.push(e.getRawIndex(w));
						break;
					case "-":
						var w = y.idx,
							M = t.getRawIndex(w);
		...
		function r(t, e, i, r, a, o, g, m, v, y, x) {
			for(var _ = 0, b = i, w = 0; r > w; w++) {
				...
				if(b === i) t[o > 0 ? "moveTo" : "lineTo"](M[0], M[1]), u(f, M);
				else if(v > 0) {
					var S = b + o,
						A = e[S];
					if(x)
						for(; A && n(e[S]);) S += o, A = e[S];
					var T = .5,
						C = e[_],
						A = e[S];
					if(!A || n(A)) u(p, M);
			...
			Polygon: o.extend({
				...
				buildPath: function(t, e) {
					var i = e.points,
						...
						l = i.length,
						h = e.smoothMonotone,
						c = a(i, e.smoothConstraint),
						u = a(o, e.smoothConstraint);
					if(e.connectNulls) {
						for(; l > 0 && n(i[l - 1]); l--);
						for(; l > s && n(i[s]); s++);
					}
					for(; l > s;) {
						...
						r(t, o, s + d - 1, d, l, -1, u.min, u.max, e.stackedOnSmooth, h, e.connectNulls), s += d + 1, t.closePath()
					}
				}
			})
		}
		...
		h.updateData = function(t, e, i) {
			...
			var o = this.childAt(0),
				...
				u = t.getItemLayout(e),
				d = l.extend({}, u);
			d.label = null, i ? (o.setShape(d), o.shape.endAngle = u.startAngle, s.updateProps(o, {
				shape: {
					endAngle: u.endAngle
				}
			}, h, e)) : s.updateProps(o, {
			...
			o.useStyle(l.defaults({
				fill: p
			}, f.getModel("normal").getItemStyle())), o.hoverStyle = f.getModel("emphasis").getItemStyle(), r(this, t.getItemLayout(e), c.get("selected"), h.get("selectedOffset"), h.get("animation")), o.off("mouseover").off("mouseout").off("emphasis").off("normal"), c.get("hoverAnimation") && o.on("mouseover", n).on("mouseout", a).on("emphasis", n).on("normal", a), this._updateLabel(t, e), s.setHoverStyle(this)
			...
			var u = a.getModel("label.normal"),
				d = a.getModel("label.emphasis"),
				f = a.getModel("labelLine.normal"),
				p = a.getModel("labelLine.emphasis"),
				g = u.get("position") || d.get("position");
			n.setStyle(o(t, e, "normal", u, g)), n.ignore = n.normalIgnore = !u.get("show"), n.hoverIgnore = !d.get("show"), i.ignore = i.normalIgnore = !f.get("show"), i.hoverIgnore = !p.get("show"), i.setStyle({
				stroke: c,
				opacity: t.getItemVisual(e, "opacity")
			}), i.setStyle(f.getModel("lineStyle").getLineStyle()), n.hoverStyle = o(t, e, "emphasis", d, g), i.hoverStyle = p.getModel("lineStyle").getLineStyle();
			var m = f.get("smooth");
				...
				if(!r || r.from !== this.uid) {
					...
					if(o.diff(s).add(function(t) {
							...
							u && e.eachChild(function(t) {
								t.stopAnimation(!0)
							}), f && e.on("click", d), o.setItemGraphicEl(t, e), h.add(e)
						}).update(function(t, e) {
							var i = s.getItemGraphicEl(e);
							i.updateData(o, t), i.off("click"), f && i.on("click", d), h.add(i), o.setItemGraphicEl(t, i)
						}).remove(function(t) {
							var e = s.getItemGraphicEl(t);
							h.remove(e)
						}).execute(), c && u && o.count() > 0) {
		...
		t.exports = function(t, e, i, n) {
			...
			}), !c && t.get("avoidLabelOverlap") && r(h, o, s, e, i, n)
		}
	}, function(t, e, i) {
		var n = i(4),
			r = n.parsePercent,
		...
		function n(t, e) {
			...
			u.x.onZero = Math.max(Math.min(i("y"), u.x.bottom), u.x.top), u.y.onZero = Math.max(Math.min(i("x"), u.y.right), u.y.left), a.position = ["y" === l ? u.y[s] : c[0], "x" === l ? u.x[s] : c[3]];
			var d = {
				x: 0,
				y: 1
			};
			...
			a.labelDirection = a.tickDirection = a.nameDirection = f[o], r.onZero && (a.labelOffset = u[l][o] - u[l].onZero), e.getModel("axisTick").get("inside") && (a.tickDirection = -a.tickDirection), e.getModel("axisLabel").get("inside") && (a.labelDirection = -a.labelDirection);
		...
		function r(t, e, i, r, a, o) {
			...
			s[a] = e.get(i, h, !0), s[o] = e.get(r, h, !0);
			var c = n(e, r, h);
		...
		var a = i(1),
			...
			c = function(t, e) {
				...
				if(e && (isNaN(parseFloat(e.x)) || isNaN(parseFloat(e.y))) && !a.isArray(e.coord) && n) {
					var r = u(e, i, n, t);
					if(e = a.clone(e), e.type && h[e.type] && r.baseAxis && r.valueAxis) {
						var o = n.dimensions,
							l = s(o, r.baseAxis.dim),
							c = s(o, r.valueAxis.dim);
		...
		function r(t, e) {
			...
			o.each(t, function(t, e) {
				...
				h && !s[l].width && (h = Math.min(o.remainedWidth, h), s[l].width = h, o.remainedWidth -= h), c && (s[l].maxWidth = c), null != u && (o.gap = u), null != d && (o.categoryGap = d)
			});
			var r = {};
			return o.each(i, function(t, e) {
				r[e] = {};
				var i = t.stacks,
					n = t.axis,
					a = n.getBandWidth(),
					...
					u = t.autoWidthCount,
					d = (c - s) / (u + (u - 1) * h);
				d = Math.max(d, 0), o.each(i, function(t, e) {
					var i = t.maxWidth;
			...
			e.eachSeriesByType(t, function(t) {
				...
				s[o] = s[o] || [], e.setLayout({
					...
					if(!isNaN(t)) {
						...
						var n, r, a, l, g = t >= 0 ? "p" : "n",
							m = p[i],
							v = s[o][i][g];
						u.isHorizontal() ? (n = v, r = m[1] + h, a = m[0] - v, l = c, Math.abs(a) < d && (a = (0 > a ? -1 : 1) * d), s[o][i][g] += a) : (n = m[0] + h, r = v, a = c, l = m[1] - v, Math.abs(l) < d && (l = (0 >= l ? -1 : 1) * d), s[o][i][g] += l), e.setItemLayout(i, {
							x: n,
							y: r,
							width: a,
							height: l
		...
		function o(t, e) {
			...
			p(e, function(t, e) {
				...
				var n = t.exist,
					...
					a = t.keyInfo;
				if(x(r)) {
					if(a.name = null != r.name ? r.name + "" : n ? n.name : "\x00-", n) a.id = n.id;
		...
		var u = i(1),
			...
			M = f.extend({
				...
				mergeOption: function(t) {
					function e(e, r) {
						...
						i[e] = [], n[e] = [], p(h, function(t, r) {
							var a = t.exist,
								o = t.option;
							if(u.assert(x(o) || a, "Empty component definition"), o) {
								var s = _.getClass(e, t.keyInfo.subType, !0);
								a && a instanceof s ? (a.mergeOption(o, this), a.optionUpdated(this)) : (a = new s(o, this, this, u.extend({
									dependentModels: c,
									componentIndex: r
				...
				queryComponents: function(t) {
					...
					var o;
					if(null != i) v(i) || (i = [i]), o = g(m(i, function(t) {
						return a[t]
					}), function(t) {
						return !!t
					});
		...
		function r(t, e) {
			...
			return n || (n = t), n.timeline || (n.timeline = o), d([n].concat(r).concat(h.map(a, function(t) {
				return t.option
			})), function(t) {
				d(e, function(e) {
					e(t)
		...
		n.prototype = {
			...
			getMediaOption: function(t) {
				...
				for(var h = 0, c = n.length; c > h; h++) a(n[h].query, e, i) && o.push(h);
		...
		t.exports = function(t) {
			u(t.series, function(t) {
				...
				var i = t[e];
				i && (o.isArray(i) || (i = [i]), u(i, function(t) {
					a(t)
				}))
			})
		}
		...
		t.exports = function(t) {
			if(t) {
				...
				if(e) {
					...
					var a = t.markPoint;
					if(a && a.data)
						for(var o = a.data, i = 0; i < o.length; i++) n(o[i]);
					var s = t.markLine;
					if(s && s.data)
				...
				niceTicks: function(t) {
					...
					if(!(i === 1 / 0 || 0 >= i)) {
						var n = u(10, h(f(i / t) / Math.LN10)),
							r = t / i * n;
						.5 >= r && (n *= 10);
						var o = [a.round(c(e[0] / n) * n), a.round(h(e[1] / n) * n)];
		...
		i.throttle = function(t, e, i, n) {
			function r(r) {
				function f() {
					c = (new Date).getTime(), u = null, (d ? t : t[r]).apply(o, s || [])
				}
				var p = function() {
					l = (new Date).getTime(), o = this, s = arguments, a = l - (n ? h : c) - e, clearTimeout(u), n ? i ? u = setTimeout(f, e) : a >= 0 && f() : a >= 0 ? f() : i && (u = setTimeout(f, -a)), h = l
				};
		...
		}, i.createOrUpdate = function(t, e, a, o) {
			var s = t[e];
			if(s && null != a && o) {
				var l = s[n] || s,
					h = s[r];
				h !== a && (s = t[e] = i[o](l, a), s[n] = l, s[r] = a)
			}
		...
		s.prototype = {
			...
			resize: function(t, e) {
				var i = this.dpr,
					...
					r = n.style,
					a = this.domBack;
				r.width = t + "px", r.height = e + "px", n.width = t * i, n.height = e * i, 1 != i && this.ctx.scale(i, i), a && (a.width = t * i, a.height = e * i, 1 != i && this.ctxBack.scale(i, i))
			},
			clear: function(t) {
				var e = this.dom,
					i = this.ctx,
		...
		v.prototype = {
			...
			_paintList: function(t, e) {
				...
				f && r.restore(), this.eachBuildinLayer(o)
			},
			getLayer: function(t) {
		...
		o.prototype = {
			...
			updateDisplayList: function(t) {
				...
				for(var r = 0, a = i.length; a > r; r++) i[r].__renderidx = r;
				i.sort(n)
			},
		...
		s.prototype = {
			...
			_update: function() {
				for(var t = (new Date).getTime(), e = t - this._time, i = this._clips, n = i.length, r = [], a = [], o = 0; n > o; o++) {
					var s = i[o],
						l = s.step(t);
					l && (r.push(l), a.push(s))
				}
		...
		var n = i(57).normalizeRadian,
			r = 2 * Math.PI;
		t.exports = {
			containStroke: function(t, e, i, a, o, s, l, h, c) {
				if(0 === l) return !1;
				var u = l;
				h -= t, c -= e;
		...
		var n = i(15);
		t.exports = {
			containStroke: function(t, e, i, r, a, o, s, l, h, c, u) {
				if(0 === h) return !1;
				var d = h;
				if(u > e + d && u > r + d && u > o + d && u > l + d || e - d > u && r - d > u && o - d > u && l - d > u || c > t + d && c > i + d && c > a + d && c > s + d || t - d > c && i - d > c && a - d > c && s - d > c) return !1;
				var f = n.cubicProjectPoint(t, e, i, r, a, o, s, l, c, u, null);
				return d / 2 >= f
			}
		}
	}, function(t, e) {
		...
		function a(t, e, i, n, a, o, s, l, h, c) {
			if(c > e && c > n && c > o && c > l || e > c && n > c && o > c && l > c) return 0;
			var u = g.cubicRootAt(e, n, o, l, c, _);
			if(0 === u) return 0;
			for(var d, f, p = 0, m = -1, v = 0; u > v; v++) {
				var y = _[v],
					x = g.cubicAt(t, i, a, s, y);
				h > x || (0 > m && (m = g.cubicExtrema(e, n, o, l, b), b[1] < b[0] && m > 1 && r(), d = g.cubicAt(e, n, o, l, b[0]), m > 1 && (f = g.cubicAt(e, n, o, l, b[1]))), p += 2 == m ? y < b[0] ? e > d ? 1 : -1 : y < b[1] ? d > f ? 1 : -1 : f > l ? 1 : -1 : y < b[0] ? e > d ? 1 : -1 : d > l ? 1 : -1)
			}
			return p
		}
		...
		function o(t, e, i, n, r, a, o, s) {
			...
			if(h >= 0 && 1 >= h) {
				for(var c = 0, u = g.quadraticAt(e, n, a, h), d = 0; l > d; d++) {
					var f = g.quadraticAt(t, i, r, _[d]);
					o > f || (c += _[d] < h ? e > u ? 1 : -1 : u > a ? 1 : -1)
				}
				return c
			}
			var f = g.quadraticAt(t, i, r, _[0]);
			return o > f ? 0 : e > a ? 1 : -1
		}
			...
			for(var c = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
				...
				switch(1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
					...
					case h.C:
						...
						} else c += a(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], r, l) || 0;
						p = t[_++], g = t[_++];
						break;
					case h.Q:
						if(i) {
							if(d.containStroke(p, g, t[_++], t[_++], t[_], t[_ + 1], e, r, l)) return !0
						} else c += o(p, g, t[_++], t[_++], t[_], t[_ + 1], r, l) || 0;
						p = t[_++], g = t[_++];
						break;
					case h.A:
						var w = t[_++],
		...
		t.exports = {
			containStroke: function(t, e, i, r, a, o, s, l, h) {
				if(0 === s) return !1;
				var c = s;
				if(h > e + c && h > r + c && h > o + c || e - c > h && r - c > h && o - c > h || l > t + c && l > i + c && l > a + c || t - c > l && i - c > l && a - c > l) return !1;
				var u = n.quadraticProjectPoint(t, e, i, r, a, o, l, h, null);
				return c / 2 >= u
			}
		}
	}, function(t, e) {
		...
		n.prototype = {
			...
			textShadowOffsetY: 0,
			bind: function(t, e) {
				for(var n = this.fill, r = this.stroke, a = 0; a < i.length; a++) {
					var o = i[a];
			...
			createLinearGradient: function(t, e, i) {
				var n = e.x * i.width + i.x,
					...
					a = e.y * i.height + i.y,
					o = e.y2 * i.height + i.y,
					s = t.createLinearGradient(n, a, r, o);
				return s
			},
			...
			getGradient: function(t, e, i) {
				for(var n = "radial" === e.type ? "createRadialGradient" : "createLinearGradient", r = this[n](t, e, i), a = e.colorStops, o = 0; o < a.length; o++) r.addColorStop(a[o].offset, a[o].color);
				return r
			}
		};
		var r, a, o = n.prototype;
		for(a = 0; a < i.length; a++) r = i[a], r in o || (o[r] = null);
		t.exports = n
	}, function(t, e, i) {
		var n = i(5),
			r = n.min,
		...
		t.exports = function(t, e, i, h) {
			...
			if(h) {
				d = [1 / 0, 1 / 0], f = [-(1 / 0), -(1 / 0)];
				for(var y = 0, x = t.length; x > y; y++) r(d, d, t[y]), a(f, f, t[y]);
				r(d, d, h[0]), a(f, f, h[1])
			}
			for(var y = 0, x = t.length; x > y; y++) {
				...
				var S = l([], _, m),
					A = l([], _, v);
				h && (a(S, S, d), r(S, S, f), a(A, A, d), r(A, A, f)), p.push(S), p.push(A)
			}
		...
		t.exports = function(t, e) {
			...
			for(var s = 0; l > s; s++) {
				...
				var m = p * p,
					v = p * m;
				a.push([n(h[0], g[0], c[0], u[0], p, m, v), n(h[1], g[1], c[1], u[1], p, m, v)])
			}
			return a
		}
	}, function(t, e, i) {
		...
		t.exports = i(6).extend({
			...
			buildPath: function(t, e) {
				var i = e.x1,
					...
					u = e.cpy2,
					f = e.percent;
				0 !== f && (t.moveTo(i, n), null == c || null == u ? (1 > f && (o(i, l, r, f, d), l = d[1], r = d[2], o(n, h, a, f, d), h = d[1], a = d[2]), t.quadraticCurveTo(l, h, r, a)) : (1 > f && (s(i, l, c, r, f, d), l = d[1], c = d[2], r = d[3], s(n, h, u, a, f, d), h = d[1], u = d[2], a = d[3]), t.bezierCurveTo(l, h, c, u, r, a)))
			},
			pointAt: function(t) {
		...
		t.exports = i(6).extend({
			...
			buildPath: function(t, e) {
				var i = e.cx,
					...
					r = 2 * Math.PI;
				t.moveTo(i + e.r, n),
					t.arc(i, n, e.r, 0, r, !1), t.moveTo(i + e.r0, n), t.arc(i, n, e.r0, 0, r, !0)
			}
		})
	}, function(t, e, i) {
		t.exports = i(6).extend({
			...
			buildPath: function(t, e) {
				var i = e.cx,
					...
					h = Math.cos(o),
					c = Math.sin(o);
				t.moveTo(h * r + i, c * r + n), t.lineTo(h * a + i, c * a + n), t.arc(i, n, a, o, s, !l), t.lineTo(Math.cos(s) * r + i, Math.sin(s) * r + n), 0 !== r && t.arc(i, n, r, s, o, l), t.closePath()
			}
		})
	}, function(t, e, i) {
		"use strict";
		...
		h.prototype = {
			...
			_animateToShallow: function(t, e, i, n, a) {
				var o = {},
					l = 0;
				for(var h in i)
					if(null != e[h]) s(i[h]) && !r.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], i[h], n, a) : (o[h] = i[h], l++);
					else if(null != i[h])
					if(t) {
						var c = {};
		...
		function n(t, e, i, n, r, a, o, s, l, h, c) {
			var g = l * (p / 180),
			...
			var b = (r === a ? -1 : 1) * u((o * o * (s * s) - o * o * (x * x) - s * s * (y * y)) / (o * o * (x * x) + s * s * (y * y))) || 0,
				...
				I = [(-1 * y - w) / o, (-1 * x - M) / s],
				k = v(C, I);
			m(C, I) <= -1 && (k = p), m(C, I) >= 1 && (k = 0), 0 === a && k > 0 && (k -= 2 * p), 1 === a && 0 > k && (k += 2 * p), c.addData(h, S, A, o, s, T, k, g, a)
		}
		...
		function r(t) {
			...
			for(e = 1; e < a.length; e++) {
				...
				for(; g < m.length && !isNaN(m[g]) && !isNaN(m[0]);) {
					var y, x, _, b, w, M, S, A = o,
						T = l;
					switch(p) {
						case "l":
							o += m[g++], l += m[g++], d = u.L, h.addData(d, o, l);
							break;
						case "L":
							o = m[g++], l = m[g++], d = u.L, h.addData(d, o, l);
							break;
						case "m":
							o += m[g++], l += m[g++], d = u.M, h.addData(d, o, l), p = "l";
							break;
						case "M":
							o = m[g++], l = m[g++], d = u.M, h.addData(d, o, l), p = "L";
							break;
						case "h":
							o += m[g++], d = u.L, h.addData(d, o, l);
							break;
						case "H":
							o = m[g++], d = u.L, h.addData(d, o, l);
							break;
						case "v":
							l += m[g++], d = u.L, h.addData(d, o, l);
							break;
						case "V":
							l = m[g++], d = u.L, h.addData(d, o, l);
							break;
						case "C":
							d = u.C, h.addData(d, m[g++], m[g++], m[g++], m[g++], m[g++], m[g++]), o = m[g - 2], l = m[g - 1];
							break;
						case "c":
							d = u.C, h.addData(d, m[g++] + o, m[g++] + l, m[g++] + o, m[g++] + l, m[g++] + o, m[g++] + l), o += m[g - 2], l += m[g - 1];
							break;
						case "S":
							y = o, x = l;
							var C = h.len(),
								I = h.data;
							r === u.C && (y += o - I[C - 4], x += l - I[C - 3]), d = u.C, A = m[g++], T = m[g++], o = m[g++], l = m[g++], h.addData(d, y, x, A, T, o, l);
							break;
						case "s":
							y = o, x = l;
							var C = h.len(),
								I = h.data;
							r === u.C && (y += o - I[C - 4], x += l - I[C - 3]), d = u.C, A = o + m[g++], T = l + m[g++], o += m[g++], l += m[g++], h.addData(d, y, x, A, T, o, l);
							break;
						case "Q":
							A = m[g++], T = m[g++], o = m[g++], l = m[g++], d = u.Q, h.addData(d, A, T, o, l);
							break;
						case "q":
							A = m[g++] + o, T = m[g++] + l, o += m[g++], l += m[g++], d = u.Q, h.addData(d, A, T, o, l);
							break;
						case "T":
							y = o, x = l;
							var C = h.len(),
								I = h.data;
							r === u.Q && (y += o - I[C - 4], x += l - I[C - 3]), o = m[g++], l = m[g++], d = u.Q, h.addData(d, y, x, o, l);
							break;
						case "t":
							y = o, x = l;
							var C = h.len(),
							...
							break;
						case "A":
							_ = m[g++], b = m[g++], w = m[g++], M = m[g++], S = m[g++], A = o, T = l, o = m[g++], l = m[g++], d = u.A, n(A, T, o, l, M, S, _, b, w, d, h);
							break;
						case "a":
							_ = m[g++], b = m[g++], w = m[g++], M = m[g++], S = m[g++], A = o, T = l, o += m[g++], l += m[g++], d = u.A, n(A, T, o, l, M, S, _, b, w, d, h)
					}
		...
		t.exports = {
			...
			mergePath: function(t, e) {
				var i, n, r = [],
					a = t.length;
				for(n = 0; a > n; n++) i = t[n], i.__dirty && i.buildPath(i.path, i.shape), r.push(i.path);
				var s = new o(e);
		...
		function n(t, e) {
			var i, n, a, c, u, d, f = t.data,
				...
				y = r.A,
				x = r.Q;
			for(a = 0, c = 0; a < f.length;) {
				switch(i = f[a++], c = a, n = 0, i) {
					case p:
						n = 1;
						break;
					case m:
					...
					case y:
						var _ = e[4],
							...
							M = l(e[2] * e[2] + e[3] * e[3]),
							S = h(-e[1] / M, e[0] / w);
						f[a++] += _, f[a++] += b, f[a++] *= w, f[a++] *= M, f[a++] += S, f[a++] += S, a += 2, c = a;
						break;
					case v:
						d[0] = f[a++], d[1] = f[a++], o(d, d, e), f[c++] = d[0], f[c++] = d[1], d[0] += f[a++], d[1] += f[a++], o(d, d, e), f[c++] = d[0], f[c++] = d[1]
				}
				for(u = 0; n > u; u++) {
					var d = s[u];
					d[0] = f[a++], d[1] = f[a++], o(d, d, e), f[c++] = d[0], f[c++] = d[1]
				}
			}
		}
		var r = i(28).CMD,
		...
		function l(t) {
			this._dragging && !this._disabled && (o(t), c.call(this, t))
		}

		function h(t) {
			this._dragging && !this._disabled && (o(t), c.call(this, t, !0), this._dragging = !1, this._track = [])
		}
			...
			s = r.extendShape({
				...
				buildPath: function(t, e) {
					for(var i = e.points, n = e.sizes, r = this.symbolProxy, a = r.shape, o = 0; o < i.length; o++) {
						var s = i[o],
							l = n[o];
						l[0] < 4 ? t.rect(s[0] - l[0] / 2, s[1] - l[1] / 2, l[0], l[1]) : (a.x = s[0] - l[0] / 2, a.y = s[1] - l[1] / 2, a.width = l[0], a.height = l[1], r.buildPath(t, a))
					}
				}
			}),
			l = n.prototype;
		...
		var n = i(1),
			r = i(2);
		i(165), i(166), r.registerVisualCoding("chart", n.curry(i(44), "scatter", "circle", null)), r.registerLayout(n.curry(i(53), "scatter")), i(36)
	}, function(t, e, i) {
		"use strict";
		var n = i(35),
			r = i(13);
		...
		i(100), i(40), i(41), i(173), i(174), i(169), i(170), i(98), i(97)
	}, function(t, e, i) {
		function n(t, e) {
			var i = [1 / 0, -(1 / 0)];
		...
		function r(t, e, i) {
			var n = i.getAxisModel(),
				...
				s = [t.start, t.end],
				u = [];
			return e = e.slice(), a(e, n, r), h(["startValue", "endValue"], function(e) {
				...
				var n = u[t],
					a = s[t];
				null != a || null == n ? (null == a && (a = o[t]), n = r.parse(l.linearMap(a, o, e, !0))) : a = l.linearMap(n, e, o, !0), u[t] = i(n), s[t] = i(a)
			}), {
				valueWindow: c(u),
				percentWindow: c(s)
			}
		...
		function o(t, e) {
			...
			if(n) {
				var a = e || 0 === n[0] && 100 === n[1],
					...
					s = !(e || 20 > o && o >= 0),
					h = e || a || s;
				i.setRange && i.setRange(h ? null : +r[0].toFixed(o), h ? null : +r[1].toFixed(o))
			}
		}
		var s = i(1),
			l = i(4),
		...
		u.prototype = {
			...
			reset: function(t) {
				if(t === this._dataZoomModel) {
					var e = this._dataExtent = n(this._dimName, this.getTargetSeriesModels()),
						i = r(t.option, e, this);
					this._valueWindow = i.valueWindow, this._percentWindow = i.percentWindow, o(this)
				}
			},
			restore: function(t) {
			...
			filterData: function(t) {
				...
				if(t === this._dataZoomModel) {
					...
					t.get("$fromToolbox") && o && "category" === o.get("type") && (r = "empty"), h(n, function(t) {
						var n = t.getData();
		...
		function r(t, e, i, n, r, s) {
			...
			if(l) {
				...
				return t = Math.max(t, 0), i[0] = (i[0] - u) * t + u, i[1] = (i[1] - u) * t + u, o(i)
			}
		}
		...
		function a(t, e, i) {
			var n = e.axis,
				r = i.rectProvider(),
				a = {};
			return "x" === n.dim ? (a.pixel = t[0], a.pixelLength = r.width, a.pixelStart = r.x, a.signal = n.inverse ? 1 : -1) : (a.pixel = t[1], a.pixelLength = r.height, a.pixelStart = r.y, a.signal = n.inverse ? -1 : 1), a
		}
		...
		var s = i(41),
			...
			d = s.extend({
				...
				_onZoom: function(t, e, i, n, a) {
					...
					return o.option.zoomLock ? this._range : this._range = r(1 / i, [n, a], this._range, e, t, o)
				}
			});
		t.exports = d
	}, function(t, e, i) {
		...
		var r = i(1),
			...
			A = s.extend({
				...
				_resetLocation: function() {
					...
					var s = u.getLayoutRect(o, n, t.padding);
					this._location = {
						x: s.x,
						y: s.y
						...
						return t.eachTargetAxis(function(o, s) {
							...
							r.each(l, function(t) {
								if(!(i || e !== !0 && r.indexOf(S, t.get("type")) < 0)) {
									var l = n(o.name),
										h = a.getComponent(o.axis, s).axis;
									i = {
										thisAxis: h,
										series: t,
										thisDim: o.name,
				...
				_updateDataInfo: function() {
					function t(t) {
						var e = a.getTransform(i.handles[t], this.group),
							...
							c = a.applyTransform([h[t] + (0 === t ? -l : l), this._size[1] / 2], e);
						n[t].setStyle({
							x: c[0],
							y: c[1],
				...
				_formatLabel: function(t, e) {
					...
					return null != a && "auto" !== a || (a = e.getPixelPrecision()), t = null == t && isNaN(t) ? "" : "category" === e.type || "time" === e.type ? e.scale.getLabel(Math.round(t)) : t.toFixed(Math.min(a, 20)), r.isString(n) && (t = n.replace("{value}", t)), t
				},
		...
		function r(t, e, i) {
			var n = new u(t.getZr());
			return n.enable(), n.on("pan", f(o, i)), n.on("zoom", f(s, i)), n
		}
			...
			g = {
				register: function(t, e) {
					...
					c.each(i, function(t, i) {
						...
						n[o] && c.indexOf(e.allCoordIds, s) < 0 && (delete n[o], t.count--)
					}), a(i);
					var l = i[s];
					l || (l = i[s] = {
						coordId: s,
					...
					l.controller.rectProvider = function() {
						return u
					}, d.createOrUpdate(l, "dispatchAction", e.throttleRate, "fixRate"), !l.dataZoomInfos[o] && l.count++, l.dataZoomInfos[o] = e
				},
		...
		i(100), i(40), i(41), i(171), i(172), i(98), i(97)
	}, function(t, e, i) {
		i(178), i(180), i(179);
		var n = i(2);
		n.registerProcessor("filter", i(181))
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
			r = i(12),
						...
						if(!f[h])
							if(p) {
								...
								var v = g.getVisual("legendSymbol") || "roundRect",
									...
									x = this._createItem(h, o, t, v, y, d, m, u);
								x.on("click", c(n, h, i)).on("mouseover", c(r, p, "", i)).on("mouseout", c(a, p, "", i)), f[h] = !0
								...
								if(!f[h] && e.legendDataProvider) {
									...
									var p = s.getItemVisual(l, "color"),
										g = "roundRect",
										m = this._createItem(h, o, t, g, null, d, p, u);
									m.on("click", c(n, h, i)).on("mouseover", c(r, e, h, i)).on("mouseout", c(a, e, h, i)), f[h] = !0
								}
							}, this)
					}, this), h.layout(s, t, i), h.addBackground(s, t)
				}
			},
			_createItem: function(t, e, i, n, r, a, o, h) {
				var c = i.get("itemWidth"),
					...
					m = e.get("icon");
				if(n = m || n, p.add(s.createSymbol(n, 0, 0, c, d, f ? o : u)), !m && r && (r !== n || "none" == r)) {
					var v = .8 * d;
					"none" === r && (r = "circle"), p.add(s.createSymbol(r, (c - v) / 2, (d - v) / 2, v, v, f ? o : u))
				}
				var y = "left" === a ? c + 5 : -5,
					x = a,
					_ = i.get("formatter");
		...
		var r = i(2),
			a = i(1);
		r.registerAction("legendToggleSelect", "legendselectchanged", a.curry(n, "toggleSelected")), r.registerAction("legendSelect", "legendselected", a.curry(n, "select")),
			r.registerAction("legendUnSelect", "legendunselected", a.curry(n, "unSelect"))
	}, function(t, e) {
		t.exports = function(t) {
		...
		i(186), i(187), i(2).registerPreprocessor(function(t) {
				...
				mergeOption: function(t, e, i, r) {
					i || e.eachSeries(function(t) {
						...
						if(s) s.mergeOption(i, e, !0);
							...
							r && n(i), a.each(i.data, function(t) {
		...
		function r(t, e, i, n, r, a, o) {
			var s, l = a.coordinateSystem,
				h = t.getItemModel(e),
				u = h.get("x"),
				d = h.get("y");
			if(null != u && null != d) s = [c.parsePercent(u, o.getWidth()), c.parsePercent(d, o.getHeight())];
			else {
				if(a.getMarkerPosition) s = a.getMarkerPosition(t.getValues(t.dimensions, e));
				else {
					var f = l.dimensions,
						p = t.get(f[0], e),
						g = t.get(f[1], e);
		...
		function a(t, e, i) {
			var r;
			r = t ? o.map(t && t.dimensions, function(t) {
			...
			var a = new s(r, i),
				l = new s(r, i),
				h = new s([], i),
				c = o.map(i.get("data"), o.curry(g, e, t, i));
			t && (c = o.filter(c, o.curry(n, t)));
			var u = t ? f.dimValueGetter : function(t) {
				return t.value
			};
			return a.initData(o.map(c, function(t) {
				return t[0]
			}), null, u), l.initData(o.map(c, function(t) {
				return t[1]
			}), null, u), h.initData(o.map(c, function(t) {
				return t[2]
			})), {
				from: a,
				to: l,
		...
		var o = i(1),
			...
			g = function(t, e, i, n) {
				...
				if(!o.isArray(n) && ("min" === a || "max" === a || "average" === a)) {
					...
					var p = f.numCalculate(r, s.valueDataDim, a);
				...
				return n = [f.dataTransform(t, n[0]), f.dataTransform(t, n[1]), o.extend({}, n[2])], n[2].type = n[2].type || "", o.merge(n[2], n[0]), o.merge(n[2], n[1]), n
			},
			m = {
		...
		o.defaults(m, h.dataFormatMixin), i(2).extendComponentView({
			type: "markLine",
			init: function() {
				this._markLineMap = {}
			},
					...
					if(e) {
						...
						a.each(function(e) {
							var s = n.getItemModel(e),
								l = s.get("type"),
								h = s.get("valueIndex");
							r(a, e, !0, l, h, t, i), r(o, e, !1, l, h, t, i)
						}), n.each(function(t) {
			...
			_renderSeriesML: function(t, e, i, n) {
				function s(e, i, a, o, s) {
					...
					r(e, i, a, o, s, t, n), e.setItemVisual(i, {
				...
				var f = a(l, t, e),
					...
					v = f.to,
					y = f.line;
				e.__from = g, e.__to = v, o.extend(e, m), e.setData(y);
				var x = e.get("symbol"),
					_ = e.get("symbolSize");
				o.isArray(x) || (x = [x, x]), "number" == typeof _ && (_ = [_, _]), f.from.each(function(t) {
					...
					}), y.setItemLayout(t, [g.getItemLayout(t), v.getItemLayout(t)]), y.setItemVisual(t, {
				...
				}), d.updateData(y), f.line.eachItemGraphicEl(function(t, i) {
					t.traverse(function(t) {
						t.dataModel = e
					})
				}), d.__keep = !0
		...
		function n(t, e, i) {
			...
			t.each(function(r) {
				...
				else if(e.getMarkerPosition) a = e.getMarkerPosition(t.getValues(t.dimensions, r));
				else if(n) {
		...
		function r(t, e, i) {
			...
			var r = new d(n, i),
				a = o.map(i.get("data"), o.curry(f.dataTransform, e));
			return t && (a = o.filter(a, o.curry(f.dataFilter, t))), r.initData(a, null, t ? f.dimValueGetter : function(t) {
				return t.value
			}), r
		}
		var a = i(39),
			...
			p = {
				formatTooltip: function(t) {
					var e = this.getData(),
						i = this.getRawValue(t),
						n = o.isArray(i) ? o.map(i, c).join(", ") : c(i),
						r = e.getName(t);
		...
		o.defaults(p, l.dataFormatMixin), i(2).extendComponentView({
			type: "markPoint",
			init: function() {
				this._symbolDrawMap = {}
			},
			...
			_renderSeriesMP: function(t, e, i) {
				...
				u || (u = c[l] = new a);
				var d = r(s, t, e);
				o.mixin(e, p), e.setData(d), n(e.getData(), t, i), d.each(function(t) {
		...
		i(190), i(191), i(196), i(194), i(192), i(193), i(195)
	}, function(t, e, i) {
		var n = i(29),
			r = i(1),
			a = i(2).extendComponentModel({
				...
				render: function(t, e, i) {
					...
					function d(n, r, s) {
						...
						a.each(h, function(s, h) {
							...
							o.setHoverStyle(v), t.get("showTitle") && (v.__title = c[h], v.on("mouseover", function() {
								v.setStyle({
									text: c[h],
							...
							})), v.trigger(n.get("iconStatus." + h) || "normal"), f.add(v), v.on("click", a.bind(r.onclick, r, e, i, h)), g[h] = v
						})
					}
					var f = this.group;
					if(f.removeAll(), t.get("show")) {
						...
						a.each(g, function(t, e) {
							v.push(e)
						}), new l(this._featureNames || [], v).add(u).update(u).remove(a.curry(u, null)).execute(), this._featureNames = v, h.layout(f, t, i), h.addBackground(f, t), f.eachChild(function(t) {
							var e = t.__title,
								n = t.hoverStyle;
							if(n && e) {
								var r = c.getBoundingRect(e, n.font),
									a = t.position[0] + f.position[0],
									o = t.position[1] + f.position[1] + p,
									s = !1;
		...
		function r(t) {
			...
			return p.each(t, function(t, i) {
				var n = t.categoryAxis,
					r = t.valueAxis,
					a = r.dim,
					o = [" "].concat(p.map(t.series, function(t) {
						return t.name
					})),
				...
				for(var l = [o.join(v)], h = 0; h < s[0].length; h++) {
		...
		function a(t) {
			return p.map(t, function(t) {
				...
				return e.each(e.dimensions, function() {
					for(var t = arguments.length, r = arguments[t - 1], a = e.getName(r), o = 0; t - 1 > o; o++) n[o] = arguments[o];
		...
		function o(t) {
			var e = n(t);
			return {
				value: p.filter([r(e.seriesGroupByCategoryAxis), a(e.other)], function(t) {
					return t.replace(/[\n\t\s]/g, "")
				}).join("\n\n" + m + "\n\n"),
				meta: e.meta
			}
		...
		function c(t) {
			for(var e = t.split(/\n+/g), i = s(e.shift()), n = [], r = 0; r < e.length; r++) {
				var a, o = s(e[r]).split(y),
					l = "",
					h = !1;
				isNaN(o[0]) ? (h = !0, l = o[0], o = o.slice(1), n[r] = {
					name: l,
					value: []
				}, a = n[r].value) : a = n[r] = [];
		...
		d.defaultOption = {
			...
			h.style.cssText = "display:block;width:100%;overflow:auto;";
		...
		var _ = {
			zoom: function(t, e, i, n) {
				var r = this._isZoomActive = !this._isZoomActive,
					a = n.getZr();
				g[r ? "take" : "release"]("globalPan", a), e.setIconStatus("zoom", r ? "emphasis" : "normal"), r ? (a.setDefaultCursorStyle("crosshair"), this._createController(t, e, i, n)) : (a.setDefaultCursorStyle("default"), this._disposeController())
			},
		...
		a.onclick = function(t, e) {
			...
			if(r.href = o, "function" == typeof MouseEvent) {
				...
				var l = i.get("lang"),
					h = '<body style="margin:0;"><img src="' + o + '" style="max-width:100%;" title="' + (l && l[0] || "") + '" /></body>',
					c = window.open();
				c.document.write(h)
			}
		}, i(29).register("saveAsImage", n), t.exports = n
	}, function(t, e, i) {
		i(199), i(200), i(2).registerAction({
			type: "showTip",
			event: "showTip",
			update: "none"
		...
		function h(t, e, i, n, r, a, o) {
			var h = o.getWidth(),
				c = o.getHeight(),
				u = a && a.getBoundingRect().clone();
			if(a && u.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], r, n.el, u)), f.isArray(t)) e = m(t[0], h), i = m(t[1], c);
		...
		i(2).extendComponentView({
				...
				if(t.from !== this.uid) {
					...
					if(null == t.x || null == t.y) {
						if(r || e.eachSeries(function(t) {
							...
							var s, l, h = o.getItemGraphicEl(n),
								u = r.coordinateSystem;
							if(u && u.dataToPoint) {
								var d = u.dataToPoint(o.getValues(f.map(u.dimensions, function(t) {
			...
			_showAxisTooltip: function(t, e, i) {
				...
				f.each(this._seriesGroupByAxis, function(t) {
					...
					var p = !1,
						g = this._lastHover;
					if("cross" === a) n(g.data, c) && (p = !0), g.data = c;
					else {
						var m = f.indexOf(l, d);
						g.data === c[m] && (p = !0), g.data = c[m]
					}
					"cartesian2d" !== o.type || p ? "polar" !== o.type || p ? "single" !== o.type || p || this._showSinglePointer(r, o, d, s) : this._showPolarPointer(r, o, d, s) : this._showCartesianPointer(r, o, d, s), "cross" !== a && this._dispatchAndShowSeriesTooltipContent(o, t.series, s, c, p)
			...
			_showCartesianPointer: function(t, e, i, n) {
				function o(i, n, a) {
					var o = "x" === i ? r(n[0], a[0], n[0], a[1]) : r(a[0], n[1], a[1], n[1]),
						s = l._getPointerElement(e, t, i, o);
					c ? d.updateProps(s, {
						shape: o
					}, t) : s.attr({
						shape: o
				...
				function s(i, n, r) {
					var o = e.getAxis(i),
						s = o.getBandWidth(),
						h = r[1] - r[0],
						u = "x" === i ? a(n[0] - s / 2, r[0], s, h) : a(r[0], n[1] - s / 2, h, s),
				...
				var l = this,
					h = t.get("type"),
					c = "cross" !== h;
				if("cross" === h) o("x", n, e.getAxis("y").getGlobalExtent()), o("y", n, e.getAxis("x").getGlobalExtent()), this._updateCrossText(e, n, t);
				else {
					var u = e.getAxis("x" === i ? "y" : "x"),
						f = u.getGlobalExtent();
					"cartesian2d" === e.type && ("line" === h ? o : s)(i, n, f)
				}
			},
			_showSinglePointer: function(t, e, i, n) {
				function a(i, n, a) {
					var s = e.getAxis(),
						h = s.orient,
						c = "horizontal" === h ? r(n[0], a[0], n[0], a[1]) : r(a[0], n[1], a[1], n[1]),
						u = o._getPointerElement(e, t, i, c);
					l ? d.updateProps(u, {
						shape: c
					}, t) : u.attr({
						shape: c
			...
			_showPolarPointer: function(t, e, i, n) {
				function a(i, n, a) {
					...
					var u = l._getPointerElement(e, t, i, o);
					f ? d.updateProps(u, {
						shape: o
					}, t) : u.attr({
						shape: o
				...
				function s(i, n, r) {
					var a, s = e.getAxis(i),
						...
						c = e.pointToCoord(n),
						u = Math.PI / 180;
					a = "angle" === i ? o(e.cx, e.cy, r[0], r[1], (-c[1] - h / 2) * u, (-c[1] + h / 2) * u) : o(e.cx, e.cy, c[0] - h / 2, c[0] + h / 2, 0, 2 * Math.PI);
				...
				var l = this,
					...
					u = e.getRadiusAxis(),
					f = "cross" !== h;
				if("cross" === h) a("angle", n, u.getExtent()), a("radius", n, c.getExtent()), this._updateCrossText(e, n, t);
				else {
			...
			_updateCrossText: function(t, e, i) {
				var n = i.getModel("crossStyle"),
					...
					o = this._crossText;
				o || (o = this._crossText = new d.Text({
					style: {
						textAlign: "left",
						...
						if(this._ticket = "", g) {
							if("string" == typeof g) d = p.formatTpl(g, v);
								...
								var x = this,
									_ = "axis_" + t.name + "_" + y,
									b = function(t, e) {
										t === x._ticket && (o.setContent(e), h(m, i[0], i[1], o, v, null, u))
									};
		...
		function i() {
			h = !1, o.length ? l = o.concat(l) : c = -1, l.length && n()
		}
		...
		if(!i(16).canvasSupported) {
			var n = i(5),
						...
						if(n instanceof f) {
							...
							if("linear" === n.type) {
								...
								var p = [n.x * c, n.y * u],
									...
									x = c,
									w = u;
								o = [(p[0] - h.x) / x, (p[1] - h.y) / w], d && b(p, p, d), x /= y[0] * S, w /= y[1] * S;
								var M = _(x, w);
								s = 0 / M, l = 2 * n.r / M - s
							}
							...
							if(T >= 2) {
								var P = C[0][0],
									...
									z = C[0][1] * e.opacity,
									B = C[1][1] * e.opacity;
								t.type = r, t.method = "none", t.focus = "100%", t.angle = a, t.color = P, t.color2 = O, t.colors = I.join(","), t.opacity = B, t.opacity2 = z
							}
				...
				V = function(t, e, i, n) {
					...
					null != i[e] && "none" !== i[e] && (r || !r && i.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", i[e] instanceof f && P(t, a), a || (a = p.createNode(e)), r ? B(a, i, n) : N(a, i), D(t, a)) : (t[r ? "filled" : "stroked"] = "false", P(t, a))
				},
				F = [
					[],
					[],
						...
						switch(r = t[o++], n = "", i = 0, r) {
							...
							case c:
								...
								var v, _, M = t[o++],
									...
									C = t[o++],
									I = t[o++];
								r === f ? (v = C, _ = I, C = (C + 2 * M) / 3, I = (I + 2 * T) / 3, M = (s + 2 * M) / 3, T = (l + 2 * T) / 3) : (v = t[o++], _ = t[o++]), F[0][0] = M, F[0][1] = T, F[1][0] = C, F[1][1] = I, F[2][0] = v, F[2][1] = _, s = v, l = _;
								break;
							case d:
								var k = 0,
									L = 0,
								...
								var G = t[o++],
									...
									T = E + x(V) * B,
									H = G ? " wa " : " at ";
								Math.abs(W - M) < 1e-10 && Math.abs(V - N) > .01 && G && (W += 270 / S), p.push(H, g(((z - R) * D + k) * S - A), w, g(((E - B) * P + L) * S - A), w, g(((z + R) * D + k) * S - A), w, g(((E + B) * P + L) * S - A), w, g((W * D + k) * S - A), w, g((Z * P + L) * S - A), w, g((M * D + k) * S - A), w, g((T * P + L) * S - A)), s = M, l = T;
								break;
							case a.R:
								var q = F[0],
									j = F[1];
								q[0] = t[o++], q[1] = t[o++], j[0] = q[0] + t[o++], j[1] = q[1] + t[o++], e && (b(q, q, e), b(j, j, e)), q[0] = g(q[0] * S - A), j[0] = g(j[0] * S - A), q[1] = g(q[1] * S - A), j[1] = g(j[1] * S - A), p.push(" m ", q[0], w, q[1], " l ", j[0], w, q[1], " l ", j[0], w, j[1], " l ", q[0], w, j[1]);
								break;
							case a.Z:
								p.push(" x ")
						}
			...
			c.prototype.brushVML = function(t) {
				...
				if(r) {
					...
					var H = G.style;
					if(S) {
						if(e && i) H.width = g(L * e * u / f) + "px", H.height = g(P * i * d / v) + "px";
						else {
							var q = new Image,
								j = this;
							q.onload = function() {
								q.onload = null, e = q.width, i = q.height, H.width = g(L * e * u / f) + "px", H.height = g(P * i * d / v) + "px", j._imageWidth = e, j._imageHeight = i, j._imageSrc = r
							}, q.src = r
						}
					...
					} else H.width = g(L * u) + "px", H.height = g(P * d) + "px", A.appendChild(G), Z && Z.parentNode && (A.removeChild(Z), this._cropEl = null);
					var U = "",
						Y = n.opacity;
					1 > Y && (U += ".Alpha(opacity=" + g(100 * Y) + ") "), U += M + ".AlphaImageLoader(src=" + r + ", SizingMethod=scale)", H.filter = U, A.style.zIndex = O(this.zlevel, this.z, this.z2), D(t, A), n.text && this.drawRectText(t, this.getBoundingRect())
				}
			...
			for(var $ = new r, Q = function(t, e, i, n) {
					var r = this.style,
						a = r.text;
					if(a) {
						var o, l, h = r.textAlign,
							c = Y(r.textFont),
							u = c.style + " " + c.variant + " " + c.weight + " " + c.size + 'px "' + c.family + '"',
							d = r.textBaseline,
							f = r.textVerticalAlign;
						i = i || s.getBoundingRect(a, u, h, d);
						var m = this.transform;
						if(m && !n && ($.copy(e), $.applyTransform(m), e = $), n) o = e.x, l = e.y;
						else {
							var v = r.textPosition,
								y = r.textDistance;
							if(v instanceof Array) o = e.x + z(v[0], e.width), l = e.y + z(v[1], e.height), h = h || "left", d = d || "top";
							else {
								var x = s.adjustTextPositionOnRect(v, e, i, y);
								o = x.x, l = x.y, h = h || x.textAlign, d = d || x.textBaseline
							}
						}
						if(f) {
							switch(f) {
						...
						var L = [o, l],
							P = C.style;
						m && n ? (b(L, L, m), A.on = !0, A.matrix = m[0].toFixed(3) + w + m[2].toFixed(3) + w + m[1].toFixed(3) + w + m[3].toFixed(3) + ",0,0", A.offset = (g(L[0]) || 0) + "," + (g(L[1]) || 0), A.origin = "0 0", P.left = "0px", P.top = "0px") : (A.on = !1, P.left = g(o) + "px", P.top = g(l) + "px"), S.string = k(a);
						try {
							S.style.font = u
						} catch(E) {}
						V(C, "fill", {
		...
		i(204), i(67).registerPainter("vml", i(203))
	}])
});